...
This is about when we need to move a legacy setup which runs on the docker to pm2 in the same environment
...
11. Get the [**Legacy-Custom Code**](https://360holdings-my.sharepoint.com/:f:/g/personal/migaram_i360_lk/EjLxI6ENmLFEt_3TGTLndxcBsuJTBHSrciq1ybTKi3LoFg?e=NYd0dm) and extract its content. Paste the files in `/v2Client`
